...
export const LANDING_DESCRIPTION =
  "Free online 3D box designer and packaging mockup generator. Create folding carton and mailer mockups in your browser—custom dimensions, PBR materials, lid & flap openings, per-face artwork, cloud save, client preview links, PNG & JSON export. Free account signup required to start designing.";
