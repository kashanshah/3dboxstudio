...
export const STUDIO_DESCRIPTION =
  "Free 3D box maker and design studio in your browser. Set dimensions, materials, openings, and per-face artwork; save to the cloud with editor and view-only preview links; export PNG snapshots and JSON backups. No signup—open source (MIT).";
